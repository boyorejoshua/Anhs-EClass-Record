...
import type { LearnerToAdd, MyClassRoster } from '../data/types';
 ...
 */
export function ClassRoster({ classId, load, add, remove }: Props) {
              ...
              {data.permissions.canWrite && (
                <div className="panel-body">
                  <p className="menu-note" style={{ margin: 0 }}>
                    Removing a learner takes them out of THIS class only. It never
