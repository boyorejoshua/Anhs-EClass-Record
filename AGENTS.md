...
Last full run: 2026-09-05, after the Help ordering fix — **262 unit**
(254 plus eight in `src/screens/Help.test.ts`), 23/23 e2e, typecheck and
build clean. The 6/6 SQL suites (76 checks) were last run on `8d51d5c`
and are untouched by that fix, which is frontend-only.
